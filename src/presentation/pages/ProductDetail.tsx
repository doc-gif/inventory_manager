        ...
        <div className="pb-24">
            ...
            <div className="px-4 pt-4 space-y-4">
                ...
                {expiringSoon && !expired && daysLeft !== null && (
                    <div
                        className="flex items-center gap-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-yellow-700 text-sm">
                                ...
                                {item.type === 'count' ? (
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span
                                                className={`text-4xl tabular-nums ${item.count === 0 ? 'text-red-500' : lowStock ? 'text-orange-500' : ''}`}>{item.count}</span>
                                    ...
                                    <div>
                                        ...
                                        <VolumeGauge level={item.volumeLevel}
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-4">
                                                <Button variant="outline" size="sm"
                                                        ...
                                                        disabled={item.count <= 0}>−</Button>
                                                <span
                                                    className={`text-3xl tabular-nums ${item.count === 0 ? 'text-muted-foreground' : lowStock ? 'text-orange-500' : ''}`}>{item.count}</span>
                                                <span className="text-muted-foreground text-sm">個</span>
                                                {lowStock && <Badge variant="destructive">在庫少</Badge>}
                                            </div>
                                        </div>
                        ...
                        {item.type === 'count' ? (
                            ...
                            <div className="space-y-6 bg-muted/20 p-4 rounded-xl border border-border">
                                <div className="space-y-1.5">
                                    ...
                                    <div className="flex items-end gap-2 py-2">
                                        {[1, 2, 3, 4, 5].map((i) => (
                                            <button key={i} type="button" onClick={() => setEditVolumeLevel(i)}
                                                    className={`w-full rounded transition-all ${i <= editVolumeLevel ? (editVolumeLevel <= 1 ? 'bg-red-500' : 'bg-blue-500') : 'bg-gray-200'}`}
                                ...
                                <div className="space-y-1.5 pt-4 border-t border-border/50">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <Button type="button" variant="outline" size="sm"
                                                className="h-10 w-10 rounded-full p-0"
                                                onClick={() => setEditCount(Math.max(0, editCount - 1))}>−</Button>
                                        <span className="text-2xl w-12 text-center tabular-nums">{editCount}</span>
                                        <Button type="button" variant="outline" size="sm"
                                                className="h-10 w-10 rounded-full p-0"
                                                onClick={() => setEditCount(editCount + 1)}>＋</Button>
                                    </div>
                                </div>
                            </div>
                        )}
